...
# Create Kernel
p_variance = gpflow.Parameter(0.1, trainable=True)
p_lengthscale = gpflow.Parameter(4, trainable=True)
p_noise_var = gpflow.Parameter(0.02, trainable=False)
...
# Confidence Bounds
Xplot = np.linspace(-265, -240, 500)[:, None]
